...
public class Directory extends FSElement{
	...
	{
		children.sort((FSElement fse1, FSElement fse2)->fse1.getName().compareTo(fse2.getName()));
		return children;
	}
    ...
    public void appendChild(FSElement child){
        ...
        Collections.sort(children, (FSElement fse1, FSElement fse2)->fse1.getName().compareTo(fse2.getName()));
    }
